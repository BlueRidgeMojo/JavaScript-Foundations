...
mortgageCalculator("Josh", 200000, 0.05, 30)
...
function mortgageCalculator (name, principal, interestRate, years, creditScore){
    ...
    if (creditScore > 740){
        console.log(monthlyRate.toFixed(2)*.95);
    }
...
mortgageCalculator("Josh", 200000, 0.05, 30, 400)
...
variableInterestRate ( 200000, .04, 30, "Josh")
